...
class EvaluationPlotter:
    ...
    def plot_metric(self, 
        ...
        # validate max-node
        if highlight_node:
            num_nodes = (list(self.evaluator.evaluated_models.values())[0].databuilder.dataorchestrator.data_context.num_nodes-1)
    ...
    def _plot_metric_map(self, 
        ...
        # reference data
        ctx     = models[0].databuilder.dataorchestrator.data_context
    ...
    def _plot_metric_best_map(self,
        ...
        ctx      = model0.databuilder.dataorchestrator.data_context
        gdf      = ctx.local_shapedata
