...
class MoransAnalysisMixin:
    ...
    def global_morans_i_timeseries(self, 
                                   df : pd.DataFrame, 
                                   W : np.ndarray, 
                                   feature : Literal['incidence','residual'] = 'incidence') -> pd.DataFrame:
        """
        """
    ...
    def local_morans_i_timeseries(self, 
                                  df : pd.DataFrame, 
                                  W : np.ndarray, 
                                  feature: Literal['incidence','residual'] = 'incidence'):
